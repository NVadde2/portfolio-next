...
const NavBar = () => {
  return (
    <nav className='main-nav work'>
      <div className="nav__details-wrap">
        <div className="nav__profile-wrapper">
          <p class="sidebar__title">Neha Reddy Vadde</p>
          <p class="sidebar__subtitle">Developer</p>
        </div>
        <div className="toggle-wrapper">
          <div className="toggle__button-wrap">
            <MaterialUISwitch sx={{ m: 1 }} defaultChecked />
            <a href="/about" class="left-toggle w-inline-block"></a>
            <a href="/about" class="right-toggle w-inline-block"></a>
            <a href="/about" class="toggle__circle-work w-inline-block"></a>
          </div>
          <p className="nav__toggle-label">Work Mode</p>
        </div>
      </div>
